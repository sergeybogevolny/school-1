...
include_once('classes/functions-transfer.php');
include_once('classes/transfer_note.class.php');
...
?>
    ...
    <script src="js/transfer-notes.js"></script>

    <!--SET SOURCE -->
    <script type="text/javascript">
        var NOTES_SOURCE = <?php echo $transfernote->getNotes($id); ?>;
    </script>
