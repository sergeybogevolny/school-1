...
$sqlraw = "SELECT
agency_settings_agency.`name` as agency,
agency_settings_agency.address,
agency_settings_agency.city,
agency_settings_agency.state,
agency_settings_agency.zip,
agency_powers_reports.date as `date`,
agency_powers_reports.net,
agency_powers_reports.buf,
agency_powers_reports.netcalculated as netsum,
agency_powers_reports.bufcalculated as bufsum,
CONCAT_WS('-',agency_powers_reports_details.prefix,agency_powers_reports_details.serial) as `power`,
agency_powers_reports_details.executed,
agency_powers_reports_details.defendant,
agency_powers_reports_details.amount,
agency_powers_reports_details.netcalculated,
agency_powers_reports_details.bufcalculated
FROM
agency_settings_agency,
agency_powers_reports
INNER JOIN agency_powers_reports_details ON agency_powers_reports_details.report_id = agency_powers_reports.id
WHERE agency_powers_reports.id=".$id;
