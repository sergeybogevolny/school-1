...
function letter_messageone($rows,$letters,$pdf){
    ...
    for($x = 0; $x < $len; $x++) {
        ...
        if (in_array($sqlid, $letters)) {
            ...
            $txt_county     = $row['county'];
            $txt_court      = $row['court'];
            $txt_body = 'You have an appearance scheduled for '.$txt_setting. ' in the '.$txt_court.' of '.$txt_county.'.  You must be on time.  Failure to make this appearance will result in a warrant being issued for your arrest.';
            ...
            tasktimeline($focus,'Letter (Message One)');
        }
    }
}
...
function letter_messagetwo($rows,$letters,$pdf){
    ...
    for($x = 0; $x < $len; $x++) {
        ...
        if (in_array($sqlid, $letters)) {
            ...
            tasktimeline($focus,'Letter (Message Two)');
        }
    }
}
...
function email_messageone($rows,$emails,$pdf){
    ...
    for($x = 0; $x < $len; $x++) {
        ...
        if (in_array($sqlid, $emails)) {
            ...
            tasktimeline($focus,'Email (Message One)');
        }
    }
...
function email_messagetwo($rows,$emails,$pdf){
    ...
    for($x = 0; $x < $len; $x++) {
        ...
        if (in_array($sqlid, $emails)) {
            ...
            tasktimeline($focus,'Email (Message Two)');
        }
    }
    $campaign = new Campaign();
	$campaign->send_email($sendemail);
...
function email_messagethree($rows,$emails,$pdf){
    ...
    for($x = 0; $x < $len; $x++) {
        ...
        if (in_array($sqlid, $emails)) {
            ...
            tasktimeline($focus,'Email (Message Three)');
        }
    }
	 $campaign = new Campaign();
	//$campaign->send_email($sendemail);
...
function text_messageone($rows,$texts,$pdf){
    ...
    for($x = 0; $x < $len; $x++) {
        ...
        if (in_array($sqlid, $texts)) {
            ...
            $txt_county     = $row['county'];
            $txt_court      = $row['court'];
            $txt_body = 'You have an appearance scheduled for '.$txt_setting. ' in the '.$txt_court.' of '.$txt_county.'.  You must be on time.';
            ...
            tasktimeline($focus,'Text (Message One)');
        }
    }
...
function text_messagetwo($rows,$texts,$pdf){
    ...
    for($x = 0; $x < $len; $x++) {
        ...
        if (in_array($sqlid, $texts)) {
            ...
            tasktimeline($focus,'Text (Message Two)');
        }
    }
    $campaign  = new Campaign();
    $campaign->send_text2($sendtext);
...
function text_messagethree($rows,$texts,$pdf){
    ...
    for($x = 0; $x < $len; $x++) {
        ...
        if (in_array($sqlid, $texts)) {
            ...
            tasktimeline($focus,'Text (Message Three)');
        }
    }
	$campaign  = new Campaign();
    $campaign->send_text2($sendtext);
...
function text_messagefour($rows,$texts,$pdf){
    ...
    for($x = 0; $x < $len; $x++) {
        ...
        if (in_array($sqlid, $texts)) {
            ...
            tasktimeline($focus,'Text (Message Four)');
        }
    }
	$campaign = new Campaign();
  $campaign->send_text2($sendtext);
...
function autocall_messageone($rows,$autocalls,$pdf){
    ...
    for($x = 0; $x < $len; $x++) {
        ...
        if (in_array($sqlid, $autocalls)) {
            ...
            $txt_county     = $row['county'];
            $txt_court      = $row['court'];
            $txt_body       = 'You have an appearance scheduled for '.$txt_setting. ' in the '.$txt_court.' of '.$txt_county.'.  You must be on time.  Failure to make this appearance will result in a warrant being issued for your arrest. If you have any questions, please contact our office. Thank you.';
            ...
            tasktimeline($focus,'AutoCall (Message One)');
        }
    }
	$campaign = new Campaign();
...
function autocall_messagetwo($rows,$autocalls,$pdf){
    ...
    for($x = 0; $x < $len; $x++) {
        ...
        if (in_array($sqlid, $autocalls)) {
            ...
            tasktimeline($focus,'AutoCall (Message Two)');
        }
    }
	$campaign = new Campaign();
	$campaign->send_autocall($sendcall);
...
function tasktimeline($focus,$template){
    ...
    if( $rcount > 0 ) {
        while($row = $query1->fetch(PDO::FETCH_ASSOC)){
            ...
            $type = 'new_campaign';
            $activity = 'Campaign for Client Court Notice - '.$template;
            $generated = 'system';
