...
$id = $_GET['id'];
// get values
$forms->getAccountreceipt($id);
$date  = date('m/d/y');
$entry = $forms->getField('entry');
$credit = number_format($forms->getField('credit'), 2, '.', ',');
...
$pdf->Cell(0, 1, 'Receipt for payment', 0, 1, 'L');
//$pdf->SetFont('Arial','B',16);
$pdf->SetFont($arial,'B',16);
$pdf->Cell(0, 12, 'Call-'.'(409)111-222', 0, 1, 'R');
$pdf->Ln();
$pdf->SetFont($arial,'',9);
...
$pdf->Text(13, 92,'_________________________________________________________________________________________');

$pdf->Text(13, 100,'_________________________________________________________________________________________');
...
$pdf->Ln();$pdf->Ln();
$pdf->Cell(0, 1, 'Amount:'.$credit .'     '.    'Method: '.$paymentmethod, 0, 2, 'L');
$pdf->Ln();
