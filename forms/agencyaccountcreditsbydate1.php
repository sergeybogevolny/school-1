...
class MYPDF extends TCPDF {
    ...
    public function Header() {
		...
		$this->Cell(40, 0, 'Last', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
		$this->Cell(45, 0, 'First', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
		$this->Cell(36, 0, 'Middle', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
		$this->Cell(42, 0, 'Type', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
		$this->Cell(41, 0, 'Method', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
		$this->Cell(41, 0, 'Amount', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
...
while( $row = $query->fetch(PDO::FETCH_ASSOC) ) {
    ...
    $txt_last     = $row['last'];
    $txt_first     = $row['first'];
    $txt_middle      = $row['middle'];
    $txt_amount   = number_format($row['credit'], 2, '.', ',');
    $txt_date       = $row['date'];
    $txt_date_mdY   = date('m/d/Y',strtotime($row['date']));
    $txt_type      = $row['entry'];
	$txt_method	=$row['paymentmethod'];
    ...
    $pdf->Cell(40, 0, $txt_last, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
    $pdf->Cell(45, 0, $txt_first, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
    $pdf->Cell(36, 0, $txt_middle, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
    $pdf->Cell(42, 0, $txt_type, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
    $pdf->Cell(41, 0, $txt_method, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
	$pdf->Cell(41, 0, $txt_amount, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
