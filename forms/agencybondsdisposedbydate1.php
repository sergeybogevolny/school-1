...
class MYPDF extends TCPDF {
    ...
    public function Header() {
		...
		$this->Cell(50, 0, 'Name', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
		$this->Cell(45, 0, 'Amount', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
		$this->Cell(26, 0, 'Class', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
		$this->Cell(42, 0, 'Charge', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
		$this->Cell(21, 0, 'Case', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
		$this->Cell(61, 0, 'County', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
...
while( $row = $query->fetch(PDO::FETCH_ASSOC) ) {
	$txt_date		=$row['disposeddate'];
    $txt_date_mdY   = date('m/d/Y',strtotime($row['disposeddate']));
    $txt_name     = $row['name'];
    $txt_class      = $row['class'];
    ...
    $pdf->Cell(50, 0, $txt_name, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
    $pdf->Cell(45, 0, $txt_amount, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
    $pdf->Cell(26, 0, $txt_class, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
    $pdf->Cell(42, 0, $txt_charge, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
    $pdf->Cell(21, 0, $txt_casenumber, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
    $pdf->Cell(61, 0, $txt_county, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
