...
class MYPDF extends TCPDF {
    ...
    public function Header() {
		...
		$this->Cell(41, 0, 'Source', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
		$this->Cell(40, 0, 'Date', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
		$this->Cell(45, 0, 'Name', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
		$this->Cell(36, 0, 'Amount', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
		$this->Cell(42, 0, 'Class', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
		$this->Cell(82, 0, 'Charge', 'B', $ln=0, 'L', 0, '', 0, false, 'T', 'C');
...
while( $row = $query->fetch(PDO::FETCH_ASSOC) ) {
    ...
    if ($group==1){
        ...
        if ($grouplastvalue!=$by){
            ...
            $pdf->SetX(132);
            $pdf->Cell(36, 0, $txt_groupsub1_us, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
            $pdf->Ln();
            $pdf->Rect(132, $gy, 36, 0.75, 'DF', $stylesingle, array(420, 420, 400));
            $pdf->Ln();
	...
	$pdf->Cell(41, 0,$txt_source, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
    $pdf->Cell(40, 0, $txt_date_mdY, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
    $pdf->Cell(45, 0, $txt_name, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
    $pdf->Cell(36, 0, $txt_amount, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
    $pdf->Cell(42, 0, $txt_class, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
    $pdf->Cell(82, 0, $txt_charge, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');

    $pdf->Ln();

    if ($group==1){
        $grouplastvalue = $txt_source;
...
if ($total==1){
    ...
    $pdf->SetX(132);
    $pdf->Cell(36, 0, $txt_grandtotal1_us, 0, $ln=0, 'L', 0, '', 0, false, 'T', 'C');
    $pdf->Ln();
    $pdf->Rect(132, $gy, 36, 0.75, 'DF', $styledouble, array(420, 420, 400));
}
