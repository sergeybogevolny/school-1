...
<div class="container-fluid" id="content">
    ...
    <?php include_once('pages/profile-nav-left.php'); ?>

    <div id="main">
		<div class="container-fluid">

            <?php include_once('pages/profile-page-header.php'); ?>
					...
					<div class="box">
						...
						<div class="box-content">
							    <div class="row-fluid">
									...
									<div class="span6">
                                       	   <form action="profile.php" class="form-horizontal" method="post" id="isForm">
