...
include_once('classes/logic_task.class.php');
...
?>
    ...
    <script src="js/logic-task.js"></script>
                                            ...
                                            <li class="button">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-primary">
                                                     ...
                                                     <?php
															foreach( $unreadtask as $unreadtask){
															   echo '<li>'.$unreadtask.'</li>';
															}
													 ?>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <div class="btn-group" style="float:right;">
                                                            <a href="#" class="btn btn-primary" id="party-view" target="_blank"><i class="icon-folder-open"></i></a>
                                                        </div>
                                                        <?php } ?>
