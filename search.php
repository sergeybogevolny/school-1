                                    ...
                                    <div class="row-fluid">
                                        ...
                                        ?>
                                            <form method="post" id="search-form">
                                                ...
                                                <button type="submit" class="btn btn-success" name="search-simple-agency" id="search-simple" style="float:left"><i class="icon-arrow-right"></i> Go</button>
                                            </form>
                    					<?php
                                        }
                                        ?>
                                        ...
                                        ?>
                                            <form method="post" id="search-form">
                                                <input type="text" name="search-value" id="search-value" class="input-large" style="float:left;margin-right:2px;height:30px;width:157px;" onKeyPress="SearchStatus(event);">
                                                <button type="submit" class="btn btn-success" name="search-simple-general" id="search-simple" style="float:left"><i class="icon-arrow-right"></i> Go</button>
                                            </form>
                    					<?php
                                        }
                                        ?>
