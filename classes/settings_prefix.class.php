...
class Settings_prefix extends Generic {
	...
	private function validate() {
	    if(empty($this->options['prefix-name'])) {
    ...
    private function unique() {
        ...
        global $generic;
        $sql = $sql = "SELECT * FROM agency_settings_lists_prefixs WHERE name = '" . $this->options['prefix-name'] . "' AND flag = 0";
    ...
    private function flag() {
		...
		$sql = "UPDATE `agency_settings_lists_prefixs` SET `flag` = :flag WHERE `id` = :id;";
    ...
    private function add() {
        ...
        $sql = "INSERT INTO `agency_settings_lists_prefixs` (`name`) VALUES (:name);";
    ...
    private function edit() {
		...
		$sql = "UPDATE `agency_settings_lists_prefixs` SET `name` = :name WHERE `id` = :id;";
    ...
    private function grab() {
		...
		$stmt   = parent::query("SELECT * FROM agency_settings_lists_prefixs WHERE id = :id;", $params);
...
$settingsprefix = new Settings_prefix();
