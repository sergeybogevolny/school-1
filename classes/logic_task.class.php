...
class Task extends Generic {
	...
	public function addTimeline(){
        ...
        $sql = "INSERT INTO `tasks_timelines` (`activity`,`progress`,`profile_id`,`task_id`,`stamp`,`generated`,`type`) VALUES ('$comment','$progress',$profile_id,$task_id,'$stamp','$generated','$type');";
		parent::query($sql);
    ...
    public function getTimeline($id) {
        ...
        <?php $i=0; while( $row = $stmt->fetch(PDO::FETCH_ASSOC) ) :
			...
			$time = date('g:m A', strtotime($datetime));
