...
class Forfeiture_note extends Generic {
    ...
    private function flag() {
		...
		$sql = "UPDATE `general_forfeitures_notes` SET `flag` = :flag WHERE `id` = :id;";
    ...
    private function add() {
        ...
        $sql = "INSERT INTO `general_forfeitures_notes` (`comment`,`user_id`,`forfeiture_id`) VALUES (:comment,:user_id,:id);";
    ...
    private function edit() {
		...
		$sql = "UPDATE `general_forfeitures_notes` SET `comment` = :comment WHERE `id` = :id;";
...
$forfeiturenote = new Forfeiture_note();
