...
class Agent_note extends Generic {
    ...
    private function flag() {
		...
		$sql = "UPDATE `general_agents_notes` SET `flag` = :flag WHERE `id` = :id;";
    ...
    private function add() {
        ...
        $sql = "INSERT INTO `general_agents_notes` (`comment`,`user_id`,`agent_id`) VALUES (:comment,:user_id,:id);";
    ...
    private function edit() {
		...
		$sql = "UPDATE `general_agents_notes` SET `comment` = :comment,`edit` = :edit WHERE `id` = :id;";
