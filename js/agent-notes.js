...
function ModifyNote(type){
    ...
    $.post('classes/agent_note.class.php', post, function (data) {
...
function agentnoteedit(id){
			...
			$.get('classes/agent_note.class.php',{noteid :id}).done(function(data){
				       console.log(data);
				       $("#note-comment").val(data);
